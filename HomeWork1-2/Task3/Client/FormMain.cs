    ...
    public partial class FormMain : Form
    {
        ...
        private void RecMsg()
        {
            try
            {
                while (true) //Постоянно отслеживать сообщения с сервера
                {
                    ...
                    {
                        textBoxLogMsg.AppendText("Связь с сервером потеряна" + "\r\n");
                        break;
                    }
                    ...
                    textBoxLogMsg.AppendText("Сервер: В " + DateTime.Now + " отправил " + strRecMsg + "\r\n");
                }
            }
            catch (SocketException ex)
            {
        ...
        private void ClientSendMsg(string sendMsg)
        {
            try
            {
                ...
                textBoxLogMsg.AppendText("Марат: В " + DateTime.Now.ToString() + " отправил " + sendMsg + "\r\n");
            }
            catch (Exception ex)
            {
                textBoxLogMsg.AppendText(ex.Message + "\r\n");
